...
if(t&&!t.isAdapterError)throw t}))}},T=(0,a.default)(S.prototype,"storeShim",[D],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),C=(0,a.default)(S.prototype,"isTruncated",[l.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!0}}),(0,a.default)(S.prototype,"onShowMoreToggle",[c.action],Object.getOwnPropertyDescriptor(S.prototype,"onShowMoreToggle"),S.prototype),(0,a.default)(S.prototype,"toggleFollow",[c.action],Object.getOwnPropertyDescriptor(S.prototype,"toggleFollow"),S.prototype),S))
e.default=A}))
...
define("feed-detail/routes/application",["exports","@babel/runtime/helpers/esm/initializerDefineProperty","@babel/runtime/helpers/esm/defineProperty","@babel/runtime/helpers/esm/classPrivateMethodGet","@babel/runtime/helpers/esm/applyDecoratedDescriptor","@babel/runtime/helpers/esm/initializerWarningHelper","@ember/destroyable","@ember/service","@ember/routing/route","@ember/object","rsvp","voyager-web/config/environment","feed-utils/utils/constants","follows/utils/follow-tracking","feed-requests/update-actions","global-utils/utils/urn-converter","data-layer/utils/feed/member-actor","data-layer/utils/organization/company-coerce","feed-utils/utils/authenticated-member-actor","feed-utils/utils/error-parsing","feed-utils/utils/gdpr","feed-utils/utils/client-sensor-constants","comments/utils/comment-requests","@linkedin/ember-restli-graphql","graphql-queries/queries/organizations/similar-company.graphql","graphql-queries/queries/feed/single-update.graphql","graphql-queries/queries/feed/single-update-by-post-slug.graphql","graphql-queries/queries/feed/single-update-by-backend-urn-or-nss.graphql","graphql-queries/queries/feed/identity-dash-profiles-by-member-identity.graphql","feed-detail/utils/constants"],(function(e,t,i,a,o,n,r,l,s,d,c,u,m,p,f,h,g,b,y,v,w,_,E,k,D,S,T,C,A,P){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
e.default=void 0
var O,I,M,U,x,R,N,j,F,z,q,L,B,G,W,H,V,Y,K,$,Q,J,Z,X
function ee(e){const t=e.urn||e.backendUrn
return null!=t&&t.includes("company")||null!=t&&t.includes("organizationalPage")?t:null}function te(e){const t=e.urn||e.backendUrn
return null!=t&&t.includes("member")?t:null}let ie=(O=(0,l.inject)("authentication@authenticated-user"),I=(0,l.inject)("feed-tracking@feed-action-event"),M=(0,l.inject)("gdpr-notice@gdpr-notice"),U=(0,l.inject)("profile-services@identity-store"),x=(0,l.inject)("i18n"),R=(0,l.inject)("jet"),N=(0,l.inject)("client-sensor-web@client-sensor"),j=(0,l.inject)("global-services@store-shim"),F=(0,l.inject)("lix"),z=(0,l.inject)("feed-utils@content-admin-identities"),q=(0,l.inject)("@linkedin/ember-restli-graphql@graphql"),L=(X=new WeakSet,class extends s.default{constructor(){super(...arguments)
X.add(this);(0,t.default)(this,"authenticatedUser",B,this);(0,t.default)(this,"feedActionEvent",G,this);(0,t.default)(this,"gdprNotice",W,this);(0,t.default)(this,"identityStore",H,this);(0,t.default)(this,"i18n",V,this);(0,t.default)(this,"jet",Y,this);(0,t.default)(this,"clientSensor",K,this);(0,t.default)(this,"storeShim",$,this);(0,t.default)(this,"lix",Q,this);(0,t.default)(this,"contentAdminIdentities",J,this);(0,t.default)(this,"graphql",Z,this);(0,i.default)(this,"queryParams",{actorCompanyId:{refreshModel:!0},origin:{refreshModel:!0},commentUrn:{refreshModel:!1},commentSort:{refreshModel:!0},replyUrn:{refreshModel:!1},likeFromLogin:{refreshModel:!1},dashCommentUrn:{refreshModel:!1},dashReplyUrn:{refreshModel:!1},originTrackingId:{refreshModel:!1},customModuleKey:{refreshModel:!1}})}get isHighlightedUpdateUrnFowardingEnabled(){return this.lix.getTreatmentIsEnabled("voyager.web.feed-allow-highlightedUpdateUrn-forwarding-on-feed-detail")}get isDashEnabled(){return this.lix.getTreatmentIsEnabled("voyager.web.feed-dash-update-detail")}beforeModel(e){super.beforeModel(...arguments)
const t=e.to?e.to.queryParams:{},{highlightedUpdateUrn:i}=t
i&&this.isHighlightedUpdateUrnFowardingEnabled&&this.replaceWithExternal("feed");(0,d.set)(this,"is3colLayout",!0)
...
return(0,c.hash)(t)}const n=te(t)||function(e){const t=e.urn||e.backendUrn
return null!=t&&t.includes("group")?t:null}(t)
...
const t=e.update.actor
if(t){var i,a
const r=null===(i=t.image)||void 0===i?void 0:i.attributes,l=r.find((e=>e.miniCompany||e.miniProfile||e.miniProfileWithRingStatus))||r[0],s=ee(t),u=l.miniProfile||(null===(a=l.miniProfileWithRingStatus)||void 0===a?void 0:a.miniProfile)
let m,p,f
...
if(g)if(this.isDashEnabled){const e=ee(g)
if(te(g)){const e=/in\/(.*)\?/,t=g.navigationContext.actionTarget.match(e),i=(null==t?void 0:t.length)>1&&t[1]
i&&(n.vieweeMemberBadges=this.fetchVieweeMemberBadges(i,this.isDashEnabled))}if(e){const t=(0,h.fromUrn)(e).id,i=(0,h.toUrn)("fsd_company",t)
n.similarOrganizations=this.fetchSimilarOrganizations(i,6)}}else{var b,y,v
const e=null===(b=g.image)||void 0===b?void 0:b.attributes,t=e.find((e=>e.miniCompany||e.miniProfile||e.miniProfileWithRingStatus))||e[0],i=null===(y=t.miniCompany)||void 0===y?void 0:y.objectUrn,a=t.miniProfile||(null===(v=t.miniProfileWithRingStatus)||void 0===v?void 0:v.miniProfile)
let o
...
n.similarOrganizations=this.fetchSimilarOrganizations(t,6)}}if(this.isDashEnabled){var w
const t=null===(w=e.update.socialDetail)||void 0===w?void 0:w.entityUrn
n.conversationStarters=this.fetchConversationStarters(t)}else{var _
const t=null===(_=e.update.socialDetail)||void 0===_?void 0:_.dashEntityUrn
n.conversationStarters=this.fetchConversationStarters(t)}if(this.isDashEnabled){var E
n.updateDetailSupplements=(0,a.default)(this,X,ae).call(this,null===(E=e.update.metadata)||void 0===E?void 0:E.backendUrn)}else{var k
n.updateDetailSupplements=(0,a.default)(this,X,ae).call(this,null===(k=e.update.updateMetadata)||void 0===k?void 0:k.urn)}this._resolveNonCriticalData(e,n)
const D=await(0,c.hash)(o)
return(0,r.isDestroying)(this)?void 0:Object.assign(e,D)}fetchConversationStarters(e){if(!e)return c.Promise.resolve(void 0)
...
return[]}throw e}))}fetchVieweeMemberBadges(e,t){return t?this.graphql.executeQuery(A.default,{memberIdentity:e}).then((e=>{var t,i,a,o,n
if((0,r.isDestroying)(this))return
...
if(!(0,r.isDestroying)(this)&&(0,v.isHttpErrorStatus)(e)){this.jet.logError(new Error("Network request failed while attempting to retrieve profile member badges"),m.JET_TAGS.GET_PROFILE_MEMBER_BADGES,!1)
return[]}throw e}))}fetchSimilarOrganizations(e,t){return this.graphql.executeQuery(D.default,{count:t,organization:e,start:0}).then((e=>{var t
...
return(0,c.all)([o,n]).then((t=>{var i,a,o,n,l,s,c,u,m,p,f,h
let[g,b]=t
if((0,r.isDestroying)(this))return
const y=b.data.socialDashCommentsBySingleComment.elements[0],v=g.data.socialDashCommentsBySingleComment.elements[0]
if(y&&(null===(i=y.parentComment)||void 0===i?void 0:i.entityUrn)!==e)return
const w=null===(a=b.data)||void 0===a||null===(o=a.socialDashCommentsBySingleComment)||void 0===o?void 0:o.elements,_=null===(n=b.data)||void 0===n||null===(l=n.socialDashCommentsBySingleComment)||void 0===l?void 0:l.metadata,E=null===(s=b.data)||void 0===s||null===(c=s.socialDashCommentsBySingleComment)||void 0===c||null===(u=c.elements)||void 0===u||null===(m=u[0])||void 0===m||null===(p=m.socialDetail)||void 0===p||null===(f=p.comments)||void 0===f?void 0:f.paging;(0,d.setProperties)(null===(h=v.socialDetail)||void 0===h?void 0:h.comments,{elements:w,metadata:_,paging:E})
return v}))}return e?(0,E.findSingleGraphQLCommentRecord)({commentUrn:e,graphql:a,updateThreadUrn:i}).then((e=>{if((0,r.isDestroying)(this))return
...
return[]}throw e})):c.Promise.resolve(void 0)}_getAnchoredComment(e,t){const{storeShim:i}=this,a="com.linkedin.voyager.feed.Comment"
if(t&&e){const o=(0,E.findSingleCommentRecord)({commentUrn:t,store:i}),n=i.findRecord(a,e)
...
const n=a.value.elements[0]
if(!n||n.parentCommentUrn===e){(0,d.set)(o,"socialDetail.comments",a.value);(0,d.set)(n,"isAnchored",!0);(0,d.set)(o,"isParentOfAnchored",!0)
return o}}))}return e?i.findRecord(a,e).then((e=>{if(!(0,r.isDestroying)(this))return this._processAnchoredComment(e)})).catch((e=>{if((0,r.isDestroying)(this))throw e
if(!(0,r.isDestroying)(this)&&(0,v.isHttpErrorStatus)(e)){this.jet.logError(new Error("Network request failed while attempting retrieve anchored comment"),m.JET_TAGS.GET_ANCHORED_COMMENT,!1)
...
g=this.graphql.executeQuery(S.default,f,{cacheKey:u,reload:!0})}else g=c.queryURL(`feed/updatesV2/${t}`,{cacheKey:u,params:p,reload:!0})
return g.then((e=>{if((0,r.isDestroying)(this))return
return this.isDashEnabled?e.data.feedDashUpdatesById:e}))}if(s){p.originTrackingId=s
f.originTrackingId=s}if(o){p.q="postSlug"
p.slug=e
f.slug=e
g=this.isDashEnabled?this.graphql.executeQuery(T.default,f,{cacheKey:u,reload:!0}):c.queryURL("feed/updatesV2",{cacheKey:u,params:p,reload:!0})
return g.then((e=>{if((0,r.isDestroying)(this))return
...
if(!(0,r.isDestroying)(this)&&(0,v.isHttpErrorStatus)(e)){this.jet.logError(new Error("Network request failed while retrieving Feed update"),m.JET_TAGS.GET_UPDATE,!1)
if("404"==`${(0,v.getStatusCode)(e)}`)throw new Error("Feed update not found")}throw e}))}if(l){p.originContext=l
if(this.isDashEnabled){Object.keys(P.UPDATE_DETAIL_ENTRY_POINTS).includes(l)?f.updateDetailEntryPoint=l:this.jet.logError(new Error(`Invalid origin context received ${l}`),"invalid-update-origin-context",!1)}}if(n){p.viewContext=n
f.viewContext=n}p.q="backendUrnOrNss"
p.urnOrNss=e
f.urnOrNss=e
g=this.isDashEnabled?this.graphql.executeQuery(C.default,f,{cacheKey:u,reload:!1}):c.queryURL("feed/updatesV2",{cacheKey:u,params:p,reload:!1})
return g.then((e=>{if((0,r.isDestroying)(this))return
...
if(!(0,r.isDestroying)(this)&&"500"===(0,v.getStatusCode)(c)&&d<1)return this.fetchPostsOrUpdateModel(e,t,i,a,o,n,l,s,d+1)
...
i=null===(s=e.updateMetadata)||void 0===s||null===(d=s.trackingData)||void 0===d?void 0:d.trackingId}return()=>({name:"FollowImpressionEvent",body:{displayModule:"IDENTITY_MODULE",entities:[{trackingId:i,followEntityUrn:t,gridPosition:{row:1,column:1}}]}})}_resolveNonCriticalData(e,t){Object.keys(t).forEach((i=>{t[i].then((t=>{if(!this.isDestroying)if("conversationStarters"===i){var a;(0,d.set)(e,i,t&&(null===(a=t.elements)||void 0===a?void 0:a[0]))}else(0,d.set)(e,i,t)}))}))}_processAnchoredComment(e){if(!e||!e.parentCommentUrn){(0,d.set)(e,"isAnchored",!0)
return e}}}),B=(0,o.default)(L.prototype,"authenticatedUser",[O],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),G=(0,o.default)(L.prototype,"feedActionEvent",[I],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),W=(0,o.default)(L.prototype,"gdprNotice",[M],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),H=(0,o.default)(L.prototype,"identityStore",[U],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),V=(0,o.default)(L.prototype,"i18n",[x],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Y=(0,o.default)(L.prototype,"jet",[R],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),K=(0,o.default)(L.prototype,"clientSensor",[N],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),$=(0,o.default)(L.prototype,"storeShim",[j],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Q=(0,o.default)(L.prototype,"lix",[F],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),J=(0,o.default)(L.prototype,"contentAdminIdentities",[z],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Z=(0,o.default)(L.prototype,"graphql",[q],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),(0,o.default)(L.prototype,"onToggleFollowForUpdateV2",[d.action],Object.getOwnPropertyDescriptor(L.prototype,"onToggleFollowForUpdateV2"),L.prototype),(0,o.default)(L.prototype,"getFollowImpressionEventPayload",[d.action],Object.getOwnPropertyDescriptor(L.prototype,"getFollowImpressionEventPayload"),L.prototype),L)
e.default=ie
function ae(e){return e?this.storeShim.queryURL(`/${u.default.namespace}/voyagerFeedDashUpdateDetailSupplement`,{params:{q:"updateDetailEntityActionComponentV2",activityUrn:e,recipe:"com.linkedin.voyager.dash.deco.feed.updatedetail.UpdateDetailEntityActionComponent"},reload:!0}).catch((e=>{if((0,r.isDestroying)(this))throw e
...
for(var a=arguments.length,o=new Array(a>1?a-1:0),n=1;n<a;n++)o[n-1]=arguments[n]
return super.model({contentUrn:t.updateId,...e},...o)}}e.default=o}))
define("feed-detail/routes/index",["exports","@babel/runtime/helpers/esm/initializerDefineProperty","@babel/runtime/helpers/esm/defineProperty","@babel/runtime/helpers/esm/applyDecoratedDescriptor","@babel/runtime/helpers/esm/initializerWarningHelper","@ember/destroyable","@ember/object","@ember/routing/route","@ember/service","feed-utils/utils/client-sensor-constants","msg-shared/utils/constants","global-utils/utils/is-browser"],(function(e,t,i,a,o,n,r,l,s,d,c,u){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
e.default=void 0
var m,p,f,h,g,b,y,v,w,_,E
const{OVERLAY:{CONTEXT_TYPES:k}}=c.default
let D=(m=(0,s.inject)("msg-overlay-manager@msg-overlay-manager"),p=(0,s.inject)("tracking"),f=(0,s.inject)("social-counts-service@social-counts"),h=(0,s.inject)("client-sensor-web@client-sensor"),g=(0,s.inject)("lix"),b=class extends l.default{constructor(){super(...arguments);(0,t.default)(this,"msgOverlayManager",y,this);(0,t.default)(this,"tracking",v,this);(0,t.default)(this,"socialCountsService",w,this);(0,t.default)(this,"clientSensor",_,this);(0,t.default)(this,"lix",E,this);(0,i.default)(this,"addComment",null);(0,i.default)(this,"pageKey","flagship3_detail_base")}get isDashEnabled(){return this.lix.getTreatmentIsEnabled("voyager.web.feed-dash-update-detail")}afterModel(e){if(!(0,n.isDestroying)(this)){super.afterModel(...arguments)
if(null!=e&&e.update){var t,i,a,o
const n=(null===(t=e.update)||void 0===t?void 0:t.updateMetadata)||(null===(i=e.update)||void 0===i?void 0:i.metadata),{detailPageType:y}=n,v=(u.default?window.location.href:"").includes("feed/update/urn:li:sponsoredContentV2")
if("LIVE_VIDEO"===y){const e=n.shareUrn
this.transitionToExternal("video-engine.live",e)}else if("LIVE_EVENT"!==y||v){if("LIVE_EVENT"===y&&v)return
{var l,s,c
if(!this.isDashEnabled){var m,p,f,h;(0,r.set)(e,"update.cachedCommentTotal",null===(m=e.update)||void 0===m||null===(p=m.socialDetail)||void 0===p||null===(f=p.comments)||void 0===f||null===(h=f.elements)||void 0===h?void 0:h.length)}const t=null===(l=e.update)||void 0===l?void 0:l.socialDetail
if(e.update.isDirty&&t){t.rollbackAttributes();(0,r.set)(e,"update.socialDetail",t)}this.clientSensor.incrementMetricCounter({groupName:d.CLIENT_SENSOR_GROUP_NAME,metricName:d.MainFeedClientSensorMetrics.DETAILS_IMPRESSION})
this.tracking.firePageViewEvent((null===(s=e.update)||void 0===s||null===(c=s.value)||void 0===c?void 0:c.detailedPageKey)||"flagship3_feed_detail")}}else{const e=n.shareUrn
this.transitionToExternal("video-engine.event",e)}const w=null===(a=e.update)||void 0===a?void 0:a.socialDetail
w&&this.socialCountsService.registerSocialCounts(w)
const _=null===(o=e.anchoredComment)||void 0===o?void 0:o.socialDetail
if(_){var g,b
const t=null===(g=e.update)||void 0===g||null===(b=g.socialDetail)||void 0===b?void 0:b.totalSocialActivityCounts
let i
t&&(i=this.socialCountsService.getSocialCountsManager(t))
this.socialCountsService.registerSocialCounts(_,i)}const E=k.FEED_CONTEXT,D=null,S=n.urn
this.msgOverlayManager.setContextualRecommendations(E,D,S)}}}beforeModel(e){const{anchor:t,originSubroute:i,initialText:a,commentSort:o,openRepostList:n}=e.to?e.to.queryParams:{}
super.beforeModel(...arguments);(0,r.setProperties)(this,{addComment:"anchorToSocialFooter"===t,originSubroute:i,initialTextAndMentions:{text:a},commentSort:o,openRepostList:"true"===n})}setupController(e){if(!(0,n.isDestroying)(this)){super.setupController(...arguments);(0,r.setProperties)(e,{addComment:this.addComment,originSubroute:this.originSubroute,initialTextAndMentions:this.initialTextAndMentions,commentSort:this.commentSort,openRepostListOnPageLoad:this.openRepostList,isDashEnabled:this.isDashEnabled})}}buildRouteInfoMetadata(){return{debug:{suggestedTeams:["ceFeed","ceConversations","media"]}}}deactivate(){this.msgOverlayManager.clearContextualRecommendations()}},y=(0,a.default)(b.prototype,"msgOverlayManager",[m],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),v=(0,a.default)(b.prototype,"tracking",[p],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),w=(0,a.default)(b.prototype,"socialCountsService",[f],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),_=(0,a.default)(b.prototype,"clientSensor",[h],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),E=(0,a.default)(b.prototype,"lix",[g],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),b)
e.default=D}))
...
e.default=void 0
var c,u,m
let p=(c=(0,l.inject)("feed-tracking@feed-action-event"),u=class extends d.default{constructor(){super(...arguments);(0,i.default)(this,"pageKey","flagship3_feed_detail_likes");(0,t.default)(this,"feedActionEvent",m,this)}model(){var e
...
if((0,n.isDestroying)(this))return
const{update:i}=this.modelFor("application"),a=null===(t=i.socialDetail)||void 0===t?void 0:t.threadId;(0,r.set)(this,"threadId",a);(0,s.isEmpty)(e.elements)&&this.replaceWith("application",this.threadId)}setupController(e){if(!(0,n.isDestroying)(this)){super.setupController(...arguments);(0,r.set)(e,"threadId",this.threadId)}}onActorClick(e){const{update:t}=this.modelFor("application"),{actorType:i}=e
let a
switch(i){case"school":a="viewSchool"
break
case"company":a="viewCompany"
break
default:a="viewMember"}const{updateMetadata:o}=t
this.feedActionEvent.fireFAE(o,{actionType:a,actionCategory:"VIEW",controlName:"like_actor"})}},m=(0,a.default)(u.prototype,"feedActionEvent",[c],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),(0,a.default)(u.prototype,"onActorClick",[r.action],Object.getOwnPropertyDescriptor(u.prototype,"onActorClick"),u.prototype),u)
e.default=p}))
...
Object.defineProperty(e,"__esModule",{value:!0})
e.default=void 0
var i=(0,t.createTemplateFactory)({id:"r7nQyQHf",block:'[[[1,[28,[35,0],[[28,[37,1],["i18n_page_title","feed-detail/templates/application"],null]],null]],[1,"\\n\\n"],[10,0],[14,1,"voyager-feed"],[14,0,"feed-container-theme feed-outlet"],[12],[1,"\\n  "],[8,[39,2],null,null,[["default"],[[[[1,"\\n    "],[8,[39,3],null,[["@template","@class"],[[52,[30,0,["is3colLayout"]],"sidebar-main-aside","main-aside"],"ghost-animate-in"]],[["sidebar","main","aside"],[[[[1,"\\n"],[41,[30,0,["is3colLayout"]],[[[1,"          "],[8,[30,1,["Sticky"]],null,null,[["default"],[[[[1,"\\n            "],[8,[39,5],[[24,0,"artdeco-card overflow-hidden full-width"]],[["@actor","@isCompanyUpdateActor","@isNonMemberUpdateActor","@backgroundImage","@followingInfo","@showPremium","@onToggleFollow","@getFollowImpressionEventPayload"],[[30,0,["updateActor"]],[30,0,["model","isCompanyUpdateActor"]],[30,0,["model","isNonMemberUpdateActor"]],[52,[30,0,["model","isDashEnabled"]],[30,0,["model","vieweeMemberBadges","backgroundImage"]],[30,0,["model","backgroundImage"]]],[30,0,["model","followingInfo"]],[30,0,["model","vieweeMemberBadges","premium"]],[28,[37,6],["onToggleFollowForUpdateV2"],null],[28,[37,6],["getFollowImpressionEventPayload",[30,0,["model","update"]]],null]]],null],[1,"\\n          "]],[]]]]],[1,"\\n"]],[]],null],[1,"      "]],[1]],[[[1,"\\n        "],[10,"h1"],[14,0,"visually-hidden"],[12],[1,"\\n          "],[1,[28,[35,1],["i18n_feed_detail_update","feed-detail/templates/application"],null]],[1,"\\n        "],[13],[1,"\\n        "],[10,0],[14,0,"update-outlet"],[15,"aria-label",[28,[37,1],["a11y_feed_detail_update","feed-detail/templates/application"],null]],[12],[1,"\\n          "],[46,[28,[37,8],null,null],null,null,null],[1,"\\n        "],[13],[1,"\\n      "]],[]],[[[1,"\\n        "],[8,[30,2,["Sticky"]],null,null,[["default"],[[[[1,"\\n          "],[8,[39,9],[[24,0,"artdeco-card overflow-hidden"]],[["@slotSize","@zone","@pageZone"],["300x250","FEED","PAGE_ZONE_BODY_RIGHT"]],null],[1,"\\n"],[41,[30,0,["model","similarOrganizations","elements","length"]],[[[1,"            "],[8,[39,10],[[24,0,"mt3"]],[["@list"],[[30,0,["model","similarOrganizations","elements"]]]],null],[1,"\\n"]],[]],null],[1,"          "],[8,[39,11],null,null,null],[1,"\\n        "]],[]]]]],[1,"\\n      "]],[2]]]]],[1,"\\n  "]],[]]]]],[1,"\\n"],[13]],["Sidebar","Aside"],false,["ember-page-title@page-title","t","ember-self-focused@self-focused","scaffold-layout@layout","if","feed@render-models/profile-rail-card","ember-route-action-helper@route-action","component","-outlet","ads@ad-banner","feed-detail@similar-pages-module","global-footer@global-footer-compact"]]',moduleName:"feed-detail/templates/application.hbs",isStrictMode:!1})
e.default=i}))
...
Object.defineProperty(e,"__esModule",{value:!0})
e.default=void 0
var i=(0,t.createTemplateFactory)({id:"nOCaBP5A",block:'[[[10,"section"],[14,0,"fixed-full"],[12],[1,"\\n  "],[8,[39,0],null,[["@anchoredComment","@authenticatedActor","@commentSort","@conversationStarters","@dashAnchoredCommentUrn","@dashAnchoredReplyUrn","@hideCaEntryPoint","@initialTextAndMentions","@isDashEnabled","@isDetailView","@model","@openRepostListOnPageLoad","@shouldFocusTexteditor","@shouldScrollToBottom","@shouldShowReshareModal","@updateDetailSupplements","@videoAnalyticsRouteName"],[[30,0,["model","anchoredComment"]],[30,0,["model","authenticatedActor"]],[30,0,["commentSort"]],[30,0,["model","conversationStarters"]],[30,0,["model","dashAnchoredCommentUrn"]],[30,0,["model","dashAnchoredReplyUrn"]],[30,0,["hideCaEntryPoint"]],[30,0,["initialTextAndMentions"]],[30,0,["isDashEnabled"]],true,[30,0,["model","update"]],[30,0,["openRepostListOnPageLoad"]],[30,0,["addComment"]],[30,0,["addComment"]],[28,[37,1],[[30,0,["originSubroute"]],"reshare"],null],[30,0,["model","updateDetailSupplements"]],"video-analytics"]],null],[1,"\\n"],[13]],[],false,["feed-shared@update/generic-update","global-helpers@eq"]]',moduleName:"feed-detail/templates/index.hbs",isStrictMode:!1})
e.default=i}))
